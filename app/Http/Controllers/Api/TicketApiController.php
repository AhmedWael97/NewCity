...
class TicketApiController extends Controller
{
     ...
     *                 @OA\Property(property="category", type="string", enum={"technical_issue", "shop_complaint", "payment_issue", "account_problem", "feature_request", "bug_report", "content_issue", "other"}),
