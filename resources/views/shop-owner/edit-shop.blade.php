    ...
    <div class="container">
        ...
        <div class="page-header">
            ...
            <div class="shop-status-container">
                <div class="status-badge status-{{ $shop->status }}">
                    @switch($shop->status)
                        @case('pending')
        ...
        <div class="form-container">
            <form action="{{ route('shop-owner.shops.update', $shop) }}" method="POST" enctype="multipart/form-data" class="shop-form">
                @csrf
                @method('PUT')
                ...
                <div class="form-section">
                    ...
                    <div class="form-group full-width">
                        ...
                        <textarea id="description" 
                                  ...
                                  placeholder="اكتب وصفاً مختصراً عن متجرك وما يميزه...">{{ old('description', $shop->description) }}</textarea>
                        @error('description')
                            <div class="error-message">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-section">
                    <div class="section-header">
                        ...
                        <p class="section-subtitle">الصور الموجودة حالياً لمتجرك</p>
                    </div>
                    ...
                    <div class="images-note">
                        <p>✅ ضع علامة على الصور التي تريد حذفها</p>
                    </div>
                </div>
                @endif
                ...
                <div class="form-section">
                    <div class="section-header">
                        ...
                        <p class="section-subtitle">أضف صوراً جديدة لمتجرك (اختياري)</p>
                    </div>

                    <div class="form-group full-width">
                        <label for="images" class="form-label">
                            <span class="label-text">صور جديدة</span>
                        </label>
                        <div class="file-upload-container">
                            ...
                            <label for="images" class="file-upload-label">
                                <div class="upload-content">
                                    ...
                                    <p class="upload-text">اضغط لاختيار صور جديدة أو اسحبها هنا</p>
                ...
                <div class="form-section">
                    ...
                    <div class="form-group full-width">
                        ...
                        <textarea id="working_hours" 
                                  ...
                                  placeholder="مثال: من السبت إلى الخميس: 8:00 ص - 11:00 م&#10;الجمعة: 2:00 م - 11:00 م">{{ old('working_hours', $shop->working_hours) }}</textarea>
                        @error('working_hours')
                            <div class="error-message">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-section">
                    <div class="submit-section">
                        <div class="submit-info">
                            <h4 class="submit-title">حفظ التعديلات</h4>
                            <p class="submit-description">
                                @if($shop->status === 'approved')
                                    ستحتاج التعديلات الجديدة إلى مراجعة من الإدارة قبل ظهورها
                                @else
                                    سيتم حفظ التعديلات وإعادة إرسالها للمراجعة
                                @endif
                            </p>
                        </div>
...
.delete-image-checkbox input[type="checkbox"]:checked + .checkmark {
