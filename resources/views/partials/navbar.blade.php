<nav class="main-nav">
    <div class="container">
        ...
        <div class="nav-categories">
            <div class="categories-menu">
                ...
                <a href="{{ route('city.services', ['city' => (isset($selectedCity) && $selectedCity) ? $selectedCity->slug : (session('selected_city') ?? 'all')]) }}" class="category-nav-item {{ request()->routeIs('user.services.*') ? 'active' : '' }}">
                    🔧 الخدمات
                </a>
                
                <a href="{{ route('fe-tare2k.index') }}" class="category-nav-item {{ request()->routeIs('fe-tare2k.*') ? 'active' : '' }}">
                    🚗 في طريقك
                </a>
    ...
    <div class="mobile-nav" id="mobileNav">
        ...
        <div class="mobile-categories">
            ...
            <a href="{{ route('fe-tare2k.index') }}">🚗 في طريقك</a>
